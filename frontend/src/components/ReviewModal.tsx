            ...
            <div className="relative z-10 w-full max-w-lg bg-white dark:bg-slate-900 shadow-2xl rounded-xl overflow-hidden border border-slate-200 dark:border-slate-800 animate-in fade-in zoom-in duration-200">
                ...
                <div className="p-6">
                    ...
                    <div className="mb-8 text-center">
                        ...
                        <p className="text-xs text-slate-400 mt-2 italic">请点击星星进行评分</p>
                    </div>
                    ...
                    <div className="mb-6">
                        ...
                        <textarea 
                            ...
                            className="w-full p-4 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200 placeholder-slate-400 focus:ring-2 focus:ring-primary focus:border-transparent transition-all outline-none resize-none"
                ...
                <div className="p-6 pt-0 flex flex-col sm:flex-row gap-3">
                    <button 
                        ...
                        disabled={submitting}
                        className="flex-1 px-6 py-3 bg-primary hover:bg-primary/90 text-white font-semibold rounded-lg transition-all shadow-md shadow-primary/20 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {submitting ? '提交中...' : '提交评价'}
                    </button>
                    <button 
                        onClick={onClose}
                        disabled={submitting}
                        className="flex-1 px-6 py-3 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-semibold rounded-lg transition-all active:scale-[0.98] disabled:opacity-50"
                    >
                        取消
                    </button>
                </div>
